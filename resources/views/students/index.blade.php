...
<div class="container">
  ...
  <div class="top-bar">
    ...
    <form class="search-form" method="GET" action="{{ route('students.index') }}">
      <input type="text" name="search" value="{{ $search }}" placeholder="Search name or email...">
      <button type="submit" class="btn btn-blue">Search</button>
    </form>

    <a href="{{ route('students.create') }}" class="btn btn-blue">+ Add Student</a>
  </div>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <div class="actions">
              <a href="{{ route('students.edit', $student->id) }}" class="btn btn-gray">Edit</a>
