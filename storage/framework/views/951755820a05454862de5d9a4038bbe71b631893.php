      ...
      <div class="row">
        <div class="form-group">
          ...
          <input type="text" name="first_name"
                 ...
                 class="<?php echo e($errors->has('first_name') ? 'err' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input type="text" name="last_name"
                 ...
                 class="<?php echo e($errors->has('last_name') ? 'err' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group">
        ...
        <input type="text" name="course"
               ...
               class="<?php echo e($errors->has('course') ? 'err' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\student-management\resources\views/students/edit.blade.php ENDPATH**/ ?>